...
export class LoginComponent implements OnInit {
  ...
  CreateForm() {
    this.form = this.fb.group({
      username: ["jeferson.arango@ucaldas.edu.co", [Validators.required, Validators.email, Validators.minLength(GeneralData.EMAIL_MIN_LENGHT)]],
      password: ["12345678", [Validators.required, Validators.minLength(GeneralData.PASSWORD_MIN_LENGHT)]]
    });
  }
